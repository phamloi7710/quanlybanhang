                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{route('deleteContact', ['id'=>$contact->id])}}" class="dropdown-item red"><i class="ft-trash-2"></i> Xoá</a>
                                                                </span>
                                                                </span>
                                                            </td>
                                                        </tr>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="list-group">
                                <a href="{{route('getContactAdmin')}}" class="list-group-item active">Tất Cả Liên Hệ</a>
                                <a href="{{route('getContactAdmin')}}?status=true" class="list-group-item list-group-item-action">Đã Liên Hệ</a>
                                <a href="{{route('getContactAdmin')}}?status=false" class="list-group-item list-group-item-action">Chưa Liên Hệ</a>
                            </div>
                        </div>
                    </div>
                </div>
