    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">{{__('general.addNewNews')}}</h3>
            </div>
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{__('general.addNewNews')}}
                            </li>
                        </ol>
                </div>
            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div class="controls">
                                                        <input name="txtAvatarUrl" id="image" class="form-control" placeholder="{{__('general.avatarUrl')}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
