            <link href="{{url('')}}/assets/frontend/v1.0/css/bpr-products-module.css" rel="stylesheet" type="text/css" />
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="footer-details">
                                    <div class="footer-detail rte">
                                        Siêu thị trực tuyến Smart Market được thành lập ngày 16/11/2000.<br>Trải qua hơn 15 năm hoạt động, Smart Market đã có những bước phát triển mạnh mẽ.
                                    </div>
                                    <div class="footer-detail rte">
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.2&appId=1965284407097212&autoLogAppEvents=1"></script>
            ...
            <script src="{{url('')}}/assets/frontend/v1.0/script/custom.js" type="text/javascript"></script>
            @yield('script')
