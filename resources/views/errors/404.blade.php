...
<html class="loading" lang="en" data-textdirection="ltr">
    <head>
        ...
        <title>Error 404 - Lỗi không tìm thấy trang
        </title>
        ...
        <link rel="stylesheet" type="text/css" href="{{url('')}}/assets/admin/app-assets/css/pages/error.css">
        <!-- END Page Level CSS-->
        <!-- BEGIN Custom CSS-->
                        ...
                        <div class="col-12 d-flex align-items-center justify-content-center">
                            <div class="col-md-4 col-10 p-0">
                                <div class="card-header bg-transparent border-0">
                                    ...
                                    <h3 class="text-uppercase text-center">Trang này không tồn tại trên hệ thống !</h3>
                                </div>
                                <div class="card-content">
                                    <div class="row py-2">
                                        <div class="col-12 col-sm-12 col-md-12">
                                            <a href="{{route('getIndex')}}" class="btn btn-primary btn-block"><i class="ft-home"></i> Trở về trang chủ</a>
                                        </div>
                                    </div>
                                </div>
