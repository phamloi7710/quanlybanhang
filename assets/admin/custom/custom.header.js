$(document).ready(function(){
    ...
    $('.selectImageFavicon').filemanager('image');
    $(".deleteImageFavicon").click(function(){
        $(".imagePreviewFavicon").attr('src','');
        $(".imagePreviewFavicon").attr('src','../../assets/admin/images/no-image.jpg');
        $("#imageFavicon").val('');
    });
});
